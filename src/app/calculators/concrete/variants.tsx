...
export const concreteVariants: CalculatorVariant[] = [
  {
    ...
    exampleOverride: (
      <>
        <p>
          <strong>Project:</strong> a 16 ft × 40 ft driveway, 5 inches
          thick, with a 10% waste allowance.
        </p>
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>Volume = 16 × 40 × (5 ÷ 12) = 266.7 ft³</li>
          <li>With 10% waste = 266.7 × 1.10 = 293.3 ft³</li>
          <li>Cubic yards = 293.3 ÷ 27 = 10.9 yd³</li>
        </ul>
        <p className="mt-3">
          At almost 11 cubic yards, bagged concrete stops making sense (that
          would be well over 400 bags) — this is squarely a ready-mix job.
          At roughly $175&ndash;$200 delivered per yard, expect around
          $1,900&ndash;$2,200 total, plus any short-load fee if your
          supplier&rsquo;s minimum order is higher than 10.9 yards.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    exampleOverride: (
      <>
        <p>
          <strong>Project:</strong> a continuous footing 40 ft long × 20 in
          wide × 12 in deep, for a load-bearing wall foundation.
        </p>
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>Volume = 40 × (20 ÷ 12) × (12 ÷ 12) = 66.7 ft³</li>
          <li>With 10% waste = 66.7 × 1.10 = 73.3 ft³</li>
          <li>Cubic yards = 73.3 ÷ 27 = 2.71 yd³</li>
        </ul>
        <p className="mt-3">
  ...
  },
  {
    ...
    exampleOverride: (
      <>
        <p>
          <strong>Project:</strong> 8 fence post holes, each 10 in diameter
          × 24 in deep — run the calculator once for one hole, then
          multiply by your post count.
        </p>
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>One hole: volume = π × (5 ÷ 12)² × 2 = 1.09 ft³</li>
          <li>With 10% waste = 1.09 × 1.10 = 1.2 ft³ per hole</li>
          <li>× 8 holes = 9.6 ft³ total</li>
          <li>80 lb bags = 9.6 ÷ 0.6 ≈ 16 bags</li>
        </ul>
        <p className="mt-3">
          At roughly $6.50 per 80 lb bag, that&rsquo;s about $104 for all 8
          posts — small enough that bagged mix is the practical choice here,
          even though it wasn&rsquo;t for the driveway or footing above.
        </p>
      </>
    ),
  },
  {
    ...
    exampleOverride: (
      <>
        <p>
          <strong>Project:</strong> 3 steps, each 4 ft wide, with a 12 in
          tread depth and 7 in riser — run the calculator once per step
          using the riser height as the slab thickness, then add them up.
        </p>
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>One step: volume = 4 × 1 × (7 ÷ 12) = 2.33 ft³</li>
          <li>× 3 steps = 7.0 ft³ total</li>
          <li>With 10% waste = 7.0 × 1.10 = 7.7 ft³</li>
          <li>Cubic yards = 7.7 ÷ 27 = 0.29 yd³, or about 13 bags of 80 lb mix</li>
        </ul>
        <p className="mt-3">
          At roughly $6.50 per bag, that&rsquo;s around $85 in bagged
          concrete for all 3 steps — small stair projects like this rarely
          justify a ready-mix delivery.
        </p>
      </>
    ),
  },
